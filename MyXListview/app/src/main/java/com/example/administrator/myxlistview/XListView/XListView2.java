...
/**
 * XListView 根据Maxwin的XListView改造而来，没有下拉刷新和加载更多的字样。参考Github链接：https://github.com/Maxwin-z/XListView-Android
 * 
 * @author MarkMjw
 * @date 2013-10-08
 */
...
//		if (!mEnablePullLoad) {
//			
//			if(null == getAdapter() || getAdapter().getCount() <= 8){
